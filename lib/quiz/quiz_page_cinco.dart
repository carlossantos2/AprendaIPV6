import 'package:aprenda_ipv6/quiz/quiz_page_seis.dart';
...
bool _allow = false;
class QuizCinco extends StatelessWidget {
  @override
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Padding(
                          ...
                          child: Text(
                              "É um exemplo válido de como utilizar o IPv6 em uma URL.",
                              style: TextStyle(
                                fontSize: 30,
                                color: Colors.black,
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){
                        push(context, QuizSeis());
                      },
                      child: Text("http://2001:fc01:0502::8090",
                          style: TextStyle(
                            fontSize: 23,
                            color: Colors.white,
                          )
